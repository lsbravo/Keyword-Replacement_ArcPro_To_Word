...
def script_tool(param0, param1, param2):
	...
	document = Document(param0)
	docx_path = os.path.dirname(param0)  # Replace with your document's path
	docx_name = os.path.basename(param0)
	docx_name_ext = os.path.splitext(docx_name)
	docx_upd_name = docx_name_ext[0] + "_Update" +docx_name_ext[1]
	
	def replace_text_in_document(dict):
		...
		document.save(os.path.join(docx_path,docx_upd_name))
	replace_text_in_document(dict_keywords)
